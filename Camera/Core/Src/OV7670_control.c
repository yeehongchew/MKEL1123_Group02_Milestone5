...
void MCO1_init(void) {
	...
	// GPIO config
	GPIO_InitStruct.Pin = GPIO_PIN_8;		//PA8 - XCLK
	...
	// GPIO AF config
	GPIO_PinAFConfig(GPIOA, GPIO_PinSource14, GPIO_AF_MCO);
...
void SCCB_init(void) {
	...
	RCC_APB1PeriphClockCmd(RCC_APB1Periph_I2C1, ENABLE);
	 ...
	 /* enable the peripheral clock for the pins used by PB8 for I2C SCL and PB9 for I2C1_SDA*/
...
void DCMI_DMA_init(void) {
	...
	// PA9 - HREF (HSYNC), PA10 - PCLK (PIXCLK), PA0 - D0, PA1 - D1, PA4 - D2, PA7 - D3
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_0 | GPIO_Pin_1 | GPIO_Pin_4 | GPIO_Pin_7 |GPIO_Pin_9 | GPIO_Pin_10;
	...
	// PB4 - D5, PB3 - VSYNC, PB10 - D6, PB0 - D7, PB5 - D4
	...
	// GPIO AF config
	GPIO_PinAFConfig(GPIOA, GPIO_PinSource0, GPIO_AF_DCMI);
	GPIO_PinAFConfig(GPIOA, GPIO_PinSource1, GPIO_AF_DCMI);
	...
	GPIO_PinAFConfig(GPIOB, GPIO_PinSource0, GPIO_AF_DCMI);
